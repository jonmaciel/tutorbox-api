...
User.create!(name: 'User system admin',email: 'user_role_admin@mail.com' , password: '123123123' , password_confirmation: '123123123', user_role: :system_admin, user_role_params: [first_system.id.to_s], organization: organization)
